...
using ProjectDemoXaf.Blazor.Server.Services;
...
namespace ProjectDemoXaf.Blazor.Server;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<ProjectDemoXafBlazorApplication>();
            builder.Modules
                ...
                .AddViewVariants()
                .Add<ProjectDemoXaf.Module.ProjectDemoXafModule>()
            	.Add<ProjectDemoXafBlazorModule>();
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(ProjectDemoXaf.Module.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(ProjectDemoXaf.Module.BusinessObjects.ApplicationUserLoginInfo);
                    ...
                    options.Events.OnAuthenticated = (externalAuthenticationContext) => {
                        ...
                        externalAuthenticationContext.Principal.Identity.AuthenticationType != SecurityDefaults.WindowsAuthentication && !(externalAuthenticationContext.Principal is WindowsPrincipal)) {
                            ...
                            object CreateApplicationUser(string userName, string providerUserId) {
                                if(objectSpace.FirstOrDefault<ProjectDemoXaf.Module.BusinessObjects.ApplicationUser>(user => user.UserName == userName) != null) {
                                    throw new ArgumentException($"The username ('{userName}') was already registered within the system");
                                }
                                var user = objectSpace.CreateObject<ProjectDemoXaf.Module.BusinessObjects.ApplicationUser>();
                            ...
                            ISecurityUserLoginInfo FindUserLoginInfo(string loginProviderName, string providerUserId) {
                                return objectSpace.FirstOrDefault<ProjectDemoXaf.Module.BusinessObjects.ApplicationUserLoginInfo>(userLoginInfo =>
